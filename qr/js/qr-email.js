(function() {
    ...
    document.getElementById('btn-download-svg').addEventListener('click', function() { if (window.trackQR) trackQR('pro_gate_click', { tool: 'qr-email', feature: 'svg_download' });  window.location.href = 'pricing.html'; });
